...
import 'package:mobile_pos/pages/sales.dart';
import 'package:permission_handler/permission_handler.dart';
import 'package:mobile_pos/pages/report.dart';
...
import 'home/widgets/greeting_widget.dart';
import 'home/widgets/statistics_widget.dart';
import 'notifications/view_model_manger/notifications_cubit.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
              ...
              icon: const Icon(IconBroken.Logout, size: 32)),
        ],
        leading: Row(
          children: [
            Padding(
                    ...
                    children: [
                      Center(
                        child: Text(
                          ...
                          style:
                              TextStyle(fontSize: 12, color: Color(0xff4c53a5)),
                        ),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      Center(
                        child: Text(
                          ...
                          style:
                              TextStyle(color: Color(0xff4c53a5), fontSize: 12),
                        ),
                      ),
                    ],
                  ),
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context).translate('suppliersC'),
                        style:
                            TextStyle(color: Color(0xff4c53a5), fontSize: 12),
                      ),
                    ],
          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  Visibility(
                    visible: Config().showBusinessName,
                    child: Padding(
                      padding: const EdgeInsets.only(left: 16, right: 5),
                      child: Text(
                        businessName, // Replace with your drawer title
                        style: const TextStyle(
                          fontSize: 20, // Large enough for visibility
                          fontWeight:
                              FontWeight.bold, // Makes the text stand out
                          color: Colors
                              .blueGrey, // Matches a subtle theme; customize to fit your design
                          letterSpacing:
                              1.2, // Slight spacing for a modern look
                        ),
                      ),
                    ),
                  ),
                  Visibility(
                    visible: Config()
                        .showProfile, // Set to `false` to hide the widget
                    child: ListTile(
                      leading: CircleAvatar(
                        backgroundImage: NetworkImage(
                            businessLogo), // Replace with your image URL
                      ...
                      subtitle: Text(
                        userEmail, // Replace with the user's email
                        style: TextStyle(
                      ...
                      onTap: () {
                        ...
                        Navigator.pushNamed(context,
                            '/profileScreen'); // Replace with the desired route
                      },
                    ),
                  ),
                  Visibility(
                    visible: Config().showSales,
                    child: ListTile(
                      leading: const Icon(
                        MdiIcons.sale,
                        color: Colors.blue,
                      ...
                      onTap: () {
                        Navigator.pushNamed(context, Sales.routeName);
                      },
                      title:
                  ...
                  Visibility(
                    visible: Config().showCustomerAccounts,
                    child: ListTile(
                      leading: Image.asset(
                  ...
                  //   },
                  //   title:
                  //       Text(AppLocalizations.of(context).translate('sync')),
                  // ),
                  Visibility(
                    visible: Config().showReports,
                    child: ListTile(
                      leading: const Icon(
                        MdiIcons.chartBar,
                        color: Colors.blue,
