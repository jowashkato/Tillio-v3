...
class _ProductsState extends State<Products> {
        ...
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setModalState) {
            return Padding(
              ...
              child: _filterDrawer(setModalState),
            );
          },
        );
      },
  ...
  Widget _filterDrawer(StateSetter setState) {
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              ...
              children: [
                Text(
                  AppLocalizations.of(context).translate('sort').toUpperCase(),
                  style: AppTheme.getTextStyle(themeData.textTheme.titleMedium,
                      fontWeight: 700, color: themeData.colorScheme.primary),
                ),
                IconButton(onPressed: () async {
                  ...
                  await productList(); // Apply filters
            ...
            Text(
              AppLocalizations.of(context).translate('filter').toUpperCase(),
              style: AppTheme.getTextStyle(themeData.textTheme.titleMedium,
                  fontWeight: 700, color: themeData.colorScheme.primary),
            ),
            Column(
              ...
              children: <Widget>[
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      child: CheckboxListTile(
                        title: Text(
                            AppLocalizations.of(context).translate('in_stock').toUpperCase()),
                        controlAffinity: ListTileControlAffinity.leading,
                        value: inStock,
            ...
            Text(
              AppLocalizations.of(context).translate('group_prices').toUpperCase(),
              style: AppTheme.getTextStyle(themeData.textTheme.titleMedium,
                  fontWeight: 700, color: themeData.colorScheme.primary),
            ),
            Container(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: kAppDefaultColor,
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: Color(0xff4c53a5).withOpacity(0.2),
                  width: 1.5,
                ),
                boxShadow: [
                  BoxShadow(
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Color(0xff4c53a5).withOpacity(0.15),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          // AppLocalizations.of(context).translate('how_to_add_items') ?? "How to Add Items",
                           "How to Add Items",
                        ...
                        Text(
                          // "${AppLocalizations.of(context).translate("out_of_stock")}",
                          // AppLocalizations.of(context).translate('tap_item_instruction') ??
                              "Simply tap on any item below to add it to your cart instantly!",
                          style: AppTheme.getTextStyle(
                  ...
                  Container(
                    ...
                    child: Icon(
                      ...
                      color: Color(0xff4c53a5).withOpacity(0.6),
                      size: MySize.size20,
                    ),
                  ),
                ],
