...
class _LayoutState extends State<Layout> {
  ...
  List<Widget> pages_index = <Widget>[Home(),const CategoryScreen(),Products(), Sales()];
  @override
  void initState() {
    super.initState();
    getPermission();
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
            icon: Icon(Icons.home,color: Color(0xFFA8ABAD),),
            label: "Home",
            activeIcon: Icon(Icons.home, color: Color(0xFF6C63FF)),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.category,color: Color(0xFFA8ABAD),),
            label: "CRM",
            activeIcon: Icon(Icons.category, color: Color(0xFF6C63FF)),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.shopping_cart,color: Color(0xFFA8ABAD),),
            label: "Products",
            activeIcon: Icon(Icons.shopping_cart, color: Color(0xFF6C63FF)),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.bar_chart,color: Color(0xFFA8ABAD),),
            label: "Sales",
            activeIcon: Icon(Icons.bar_chart, color: Color(0xFF6C63FF)),
          ),
        ],
      ),
    );
